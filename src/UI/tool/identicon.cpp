...
#include "identicon.h"
#include "lib/messenger/model/toxpk.h"
...
/**
 * @brief Converts a series of IDENTICON_COLOR_BYTES bytes to a value in the
 * range 0.0..1.0
 ...
 * @param scaleFactor the image will be a square with scaleFactor *
 * IDENTICON_ROWS pixels, must be >= 1
