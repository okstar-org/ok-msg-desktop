...
public:
    ...
    virtual PlayerWidget* player() const {
        return _player;
    }
...
class PlayerWidget : QWidget {
    Q_OBJECT
public:
    explicit PlayerWidget(QLayout* layout, QGridLayout* gLayout, VideoWidgetConfig config,
                          const ok::base::Jid& id, QWidget* parent = nullptr);
