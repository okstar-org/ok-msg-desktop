...
private slots:
    ...
    static void bitrateCallback(ToxAV* toxAV, QString friendId, uint32_t arate, uint32_t vrate,
                                void* self);
    static void audioBitrateCallback(ToxAV* toxAV, QString friendId, uint32_t rate, void* self);
    static void videoBitrateCallback(ToxAV* toxAV, QString friendId, uint32_t rate, void* self);
...
private:
    ...
    static void audioFrameCallback(ToxAV* toxAV, QString friendId, const int16_t* pcm,
