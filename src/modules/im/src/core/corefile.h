...
private:
    ...
    static void onFileReceiveCallback(Tox* tox, QString friendId, QString fileId, uint32_t kind,
    ...
    static void onFileDataCallback(Tox* tox, QString friendId, QString fileId, uint64_t pos,
                                   size_t length, void* vCore);
    static void onFileRecvChunkCallback(Tox* tox, QString friendId, QString fileId,
