...
void CoreAV::bitrateCallback(ToxAV* toxav, QString friendNum, uint32_t arate, uint32_t vrate,
                             void* vSelf) {
    CoreAV* self = static_cast<CoreAV*>(vSelf);
    Q_UNUSED(self);
    Q_UNUSED(toxav);
...
void CoreAV::audioFrameCallback(ToxAV*, QString friendNum, const int16_t* pcm, size_t sampleCount,
