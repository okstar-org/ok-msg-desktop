...
void CoreFile::onFileReceiveCallback(Tox* tox, QString friendId, QString fileId, uint32_t kind,
...
void CoreFile::onFileDataCallback(Tox* tox, QString friendId, QString fileId, uint64_t pos,
...
void CoreFile::onFileRecvChunkCallback(Tox* tox, QString friendId, QString fileId,
