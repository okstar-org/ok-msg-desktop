...
signals:
  ...
  void fileError(const JID &m_friendId, const FileHandler::File &m_file, int m_sentBytes);
  void fileAbort(const JID &m_friendId, const FileHandler::File &m_file, int m_sentBytes);
