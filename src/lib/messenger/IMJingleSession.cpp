...
void IMJingleSession::doStartFileSendTask(const Session* session, const File& file) {
...
void IMJingleSession::doStopFileSendTask(const Session* session, const File& file) {
    Q_UNUSED(session)
    qDebug() << __func__ << file.sId;
