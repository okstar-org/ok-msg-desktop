...
public:
  ...
  bool processMessage(OkAccount *account, const QString &jidFrom,
                      const QString &body, const QString &subject);
  bool processOutgoingMessage(OkAccount *account, const QString &jidTo,
  ...
  bool appendingChatMessage(OkAccount *account, const QString &contact,
...
private:
  ...
  QList<OAH_PluginOptionsTab *>
      settingsTabs_; // to be inserted into global list
  ...
  void initPopupForJid(int account, const QString &jid, const QString &text,
                       const QString &title, const QString &icon, int tipe);
...
private:
  bool appendMsgView(int account, const QString &jid,
