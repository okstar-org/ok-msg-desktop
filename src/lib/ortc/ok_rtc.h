...
class OkRTCHandler {
public:
  virtual void onCreatePeerConnection(
...
public:
  ...
  virtual void setTransportInfo(const std::string &peerId,  const std::string &sId, const OIceUdp &oIceUdp) = 0;

  virtual void setMute(bool mute) = 0;

  virtual void setRemoteMute(bool mute) = 0;

  virtual bool join(const std::string &peerId, const std::string &sId, const OJingleContentAv &context) = 0;
