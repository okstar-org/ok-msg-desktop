...
struct EncryptionKey {
    ...
    EncryptionKey(std::shared_ptr<std::array<uint8_t, kSize>> value, bool isOutgoing)
...
public:
    ...
    virtual void setIncomingVideoOutput(
            std::weak_ptr<rtc::VideoSinkInterface<webrtc::VideoFrame>> sink) = 0;
