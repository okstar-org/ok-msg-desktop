...
public:
    ...
    virtual void initPopup(const QString &text, const QString &title, const QString &icon = "psi/headline",
                           int type = 0)
        = 0;
    virtual void initPopupForJid(int account, const QString &jid, const QString &text, const QString &title,
                                 const QString &icon = "psi/headline", int type = 0)
        = 0;
...
Q_DECLARE_INTERFACE(PopupAccessingHost, "org.okstar.msg.PopupAccessingHost/0.1");
