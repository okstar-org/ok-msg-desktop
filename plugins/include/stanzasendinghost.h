...
public:
    ...
    virtual void sendMessage(int account, const QString &to, const QString &body, const QString &subject,
                             const QString &type)
        = 0;
...
Q_DECLARE_INTERFACE(StanzaSendingHost, "org.okstar.msg.StanzaSendingHost/0.1");
